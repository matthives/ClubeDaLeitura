...
Mas para não perder nenhuma revista, seu pai contratou os alunos da Academia do Programador para fazer uma aplicação que cadastra as revistas e controla os empréstimos.
...
- Não permitir excluir um amigo caso tenha empréstimos vinculados Regras de Negócio:
- Campos obrigatórios:
  ○ Amigo
